...
English / [简体中文](./README_CN.md) test
...
- 隐私安全，所有数据保存在用户浏览器本地
- 预制角色功能（角色扮演），方便地创建、分享和调试你的个性化对话
...
- 🚀 v2.0 已经发布，现在你可以使用角色扮演功能快速创建预制对话了！ 了解更多： [ChatGPT 提示词高阶技能：零次、一次和少样本提示](https://github.com/Yidadaa/ChatGPT-Next-Web/issues/138)。
